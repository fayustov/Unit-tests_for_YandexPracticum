...
class TestBooksCollector:
    ...
    @pytest.mark.parametrize('name, genre', books_and_genres_list)
    def test_get_books_for_children_add_all_genres_return_children_books(self, name, genre, collector):
        collector.add_new_book(name)
        collector.set_book_genre(name, genre)
        rating_books = ['Гордость и предубеждение и зомби', 'Что делать, если ваш кот хочет вас убить']

        assert rating_books not in collector.get_books_for_children()

    def test_get_book_genre_add_book_return_genre(self, collector, le_petit_prince):
        collector.add_new_book(le_petit_prince)
        collector.set_book_genre(le_petit_prince, 'Мультфильмы')

        expected_result = 'Мультфильмы'

        assert collector.get_book_genre(le_petit_prince) == expected_result
    ...
    def test_get_books_genre_add_book_return_book_genre_list_with_added_book(self, collector, le_petit_prince):
        collector.add_new_book(le_petit_prince)
        collector.set_book_genre(le_petit_prince, 'Мультфильмы')

        expected_result = {le_petit_prince: 'Мультфильмы'}

        assert collector.get_books_genre() == expected_result

    def test_add_book_in_favorites_add_book_return_added_book(self, collector, le_petit_prince):
        collector.add_new_book(le_petit_prince)
        collector.add_book_in_favorites(le_petit_prince)
    ...
    def test_get_list_of_favorites_books_return_favorites_list(self, collector, le_petit_prince):
        collector.add_new_book(le_petit_prince)
        collector.add_book_in_favorites(le_petit_prince)
    ...
    def test_add_new_book_twice_return_one_book(self, collector, le_petit_prince):
        collector.add_new_book(le_petit_prince)
        collector.add_new_book(le_petit_prince)
